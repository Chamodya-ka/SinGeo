...
from singeo.dataset.university import U1652DatasetEval, get_transforms
...
class Configuration:
    ...
    # Dataset
    dataset: str = 'U1652-S2St'           #  'U1652-St2S' | 'U1652-S2St'
...
if config.dataset == 'U1652-St2S':
    config.query_folder_test = os.path.join(config.data_folder, 'test/query_street')
    ...
    config.gallery_folder_test = os.path.join(config.data_folder, 'test/gallery_street')
