...
from singeo.dataset.cvact import CVACTDatasetTrainSinGeo, CVACTDatasetEval, CVACTDatasetTest
...
class Configuration:
    ...
    fov: float=180.0 # Eval fov (with unknown orientation)
...
if __name__ == '__main__':
    ...
    # Train
    train_dataset = CVACTDatasetTrainSinGeo(data_folder=config.data_folder,
